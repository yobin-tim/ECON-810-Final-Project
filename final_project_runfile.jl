...
begin
    npzwrite("Saved Results/U.npz", res.val_fun.U)
    npzwrite("Saved Results/W_L.npz", res.val_fun.W_L)
    npzwrite("Saved Results/W_H.npz", res.val_fun.W_H)
    npzwrite("Saved Results/k_pol_U.npz", res.k_pol.U)
    npzwrite("Saved Results/s_pol_U.npz", res.s_pol.U)
    # npzwrite("Saved Results/k_pol_ind_U1.npz", res.k_pol.ind_U)
    # npzwrite("Saved Results/s_pol_ind_U1.npz", res.s_pol.ind_U)
    npzwrite("Saved Results/k_pol_WL.npz", res.k_pol.W_L)
    npzwrite("Saved Results/s_pol_WL.npz", res.s_pol.W_L)
    # npzwrite("Saved Results/k_pol_ind_WL1.npz", res.k_pol_ind_W_L)
    # npzwrite("Saved Results/s_pol_ind_WL1.npz", res.s_pol_ind_W_L)
    npzwrite("Saved Results/k_pol_WH.npz", res.k_pol.W_H)
    npzwrite("Saved Results/s_pol_WH.npz", res.s_pol.W_H)
